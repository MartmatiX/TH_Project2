...
to move-students
  ask turtles with [assigned-school != nobody] [
    let target-x [pxcor] of assigned-school + random-float 1 - 0.5
    let target-y [pycor] of assigned-school + random-float 1 - 0.5
